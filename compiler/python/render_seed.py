...
def render_seed(seed_dir: Path, out_dir: Path, defaults_path: Path) -> None:
    ...
    for root, dirs, files in os.walk(seed_dir):
        ...
        for name in files:
            ...
            with src_path.open("r", encoding="utf-8") as file_handle:
            ...
            with dest_path.open("w", encoding="utf-8") as file_handle:
...
def main() -> None:
    ...
    parser.add_argument("--defaults", required=True, help="Defaults JSON/YAML")
