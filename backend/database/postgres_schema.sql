...
CREATE TABLE IF NOT EXISTS documents (
  ...
  -- `owner_person_id` VIVIO AQUI hasta el 2026-08-23. No era un hecho del documento: era una COPIA
  -- de `task_items.assigned_person_id` tomada al crearlo, y la refrescaba UNO de los cuatro caminos
  -- de relevo (solo el traspaso manual). O sea que tras cualquier relevo automatico el documento
  -- seguia figurando a nombre de quien se fue.
  --
  -- Y hacia DOS trabajos incompatibles: decidia quien puede resolver una observacion ajena —eso es
