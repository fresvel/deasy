-- Schema PostgreSQL de deasy (portado desde mariadb_schema.sql).
...
CREATE TABLE IF NOT EXISTS template_artifacts (
  ...
  lifecycle_state TEXT CHECK (lifecycle_state IN ('draft','published','retired')) NOT NULL DEFAULT 'published',
...
-- Tablas de códigos de auth (DDL embebido en mariadb_initializer.js, no en el
-- .sql fuente). Índices renombrados con prefijo (en PG el nombre es global).
...
-- ============================================================================
-- Chat / notificaciones (migrado desde MongoDB — Fase 5). Los person_id /
...
-- ============================================================================
-- Triggers de negocio portados a mano desde MariaDB (bloque DELIMITER //).
