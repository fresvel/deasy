...
- Motor de reportes y firmas: `backend/services/latex/**`, `signer/**`, `backend/services/webtemplate/**`, `docs/06-reportes-firmas/*`
...
- Salidas generadas y logs: `backend/templates/temporal/**`, `backend/public/*.pdf`, `signer/**/Informes*.pdf`, `*.log`, `*.aux`
