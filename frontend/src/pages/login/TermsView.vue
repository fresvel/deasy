<template>
  <div class="min-h-screen bg-slate-100 py-8 md:py-12 px-4 sm:px-6 flex justify-center font-sans">
    <div class="max-w-4xl w-full bg-white rounded-[2rem] shadow-2xl shadow-slate-300/50 flex flex-col border border-slate-200">
      
      <!-- Header -->
      <div class="bg-sky-700 bg-gradient-to-br from-sky-800 via-sky-700 to-sky-600 p-8 sm:p-10 rounded-t-[2rem] text-white relative overflow-hidden flex-shrink-0">
        <!-- Abstract shapes -->
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <router-link to="/register" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 text-white font-medium transition-all w-fit border-white flex-shrink-0">
      ...
      <!-- Content Container -->
      <div class="w-full p-8 sm:p-10 lg:p-12 relative flex-grow bg-white rounded-b-[2rem]">
        ...
        <div class="mt-12 pt-8 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <router-link to="/register" class="inline-flex justify-center items-center gap-2 py-3 px-6 rounded-xl text-white text-sm font-semibold bg-sky-600 hover:bg-sky-700 focus:outline-none focus:ring-4 focus:ring-sky-500/30 transition-all shadow-lg shadow-sky-600/20 w-full sm:w-auto">
            Entendido
          </router-link>
        </div>
      </div>
