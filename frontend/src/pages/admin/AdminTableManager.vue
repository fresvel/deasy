                      ...
                      <div class="dropdown" @click.stop>
                        ...
                        >
                          <li v-if="!isProcessVersionsTable">
                            <button class="dropdown-item hope-dropdown-edit" type="button" @click="openEdit(row); closeDropdown()">
                              <svg
                                width="18"
                                height="18"
                                viewBox="0 0 24 24"
                          ...
                          <li v-if="!isProcessVersionsTable">
                            <button class="dropdown-item hope-dropdown-delete" type="button" @click="openDelete(row); closeDropdown()">
                              <svg
                                width="18"
                                height="18"
                                viewBox="0 0 24 24"
