...
<template>
  <div>
    ...
    <div
      v-show="show"
      class="deasy-card fixed right-4 top-[4.5rem] z-(--z-notificaciones) flex w-[calc(100vw-2rem)] origin-top-right transform flex-col overflow-hidden shadow-[0_1px_2px_rgba(var(--elev-ink-rgb),0.04),0_18px_48px_rgba(var(--elev-ink-rgb),0.12)] transition-all duration-200 sm:right-6 sm:w-80 md:w-96 lg:right-8"
