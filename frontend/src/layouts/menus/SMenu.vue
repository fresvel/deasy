<template>
  <aside 
    class="flex flex-col w-[280px] shrink-0 h-[calc(100vh-4rem)] z-40 overflow-y-auto border-r border-[rgba(226,242,250,0.03)] bg-[linear-gradient(180deg,#2b4854_0%,#3b5c69_36%,#4c6f7d_74%,#5a7a88_100%)] p-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden transition-all duration-300 left-0
