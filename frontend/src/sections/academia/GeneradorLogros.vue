<template>
  <div class="w-full animate-fade-in p-5 bg-white rounded-2xl shadow-sm border border-slate-100">
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-6 bg-slate-50 p-5 rounded-2xl border border-slate-100">
      <div class="md:col-span-4 lg:col-span-4 flex flex-col gap-1">
      ...
      <div class="md:col-span-3 lg:col-span-3 flex flex-col gap-1">
      ...
      <div class="md:col-span-2 lg:col-span-2 flex flex-col gap-1">
      ...
      <div class="md:col-span-3 lg:col-span-3 flex flex-col justify-end gap-1 pt-4 lg:pt-0">
        <input type="file" accept=".csv" id="csv_input" class="hidden" v-on:change="onfileChange()" name="file" ref="csv_input">
        <label for="csv_input" class="w-full px-3 py-2 text-sm bg-white border border-dashed border-sky-300 text-sky-700 hover:bg-sky-50 hover:border-sky-500 rounded-lg text-center font-medium cursor-pointer transition-all flex items-center justify-center gap-1.5 h-[38px]">
