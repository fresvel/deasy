  ...
  <div :class="rootClass">
    ...
    >
      ...
      <span class="relative inline-block w-11 h-6 shrink-0" :class="{ 'cursor-pointer': !disabled }">
        ...
        ></span>
        <span
          class="absolute top-1/2 left-0.5 -translate-y-1/2 size-5 rounded-full bg-white shadow-theme-lg transition-transform duration-200 ease-in-out peer-checked:translate-x-full"
        ></span>
      </span>
    </label>
  </div>
