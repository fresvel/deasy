  ...
  <div :class="rootClass">
    ...
    >
      ...
      <span class="relative inline-block w-11 h-6 shrink-0" :class="{ 'cursor-pointer': !disabled }">
        ...
        />
        <span
          class="absolute inset-0 rounded-full bg-slate-300 transition-colors duration-200 ease-in-out peer-checked:bg-[#5e4eff] peer-focus-visible:ring-4 peer-focus-visible:ring-[#5e4eff]/20 peer-disabled:opacity-50 peer-disabled:pointer-events-none"
        ></span>
        <span
