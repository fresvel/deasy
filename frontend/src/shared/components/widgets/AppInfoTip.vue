<template>
  ...
  >
    <button
      type="button"
      class="deasy-info-tip__trigger inline-flex h-4 w-4 items-center justify-center rounded-full text-slate-400 transition-colors hover:text-slate-600 focus:text-slate-600 focus:outline-none"
    ...
    <span
      v-show="open"
      role="tooltip"
      class="deasy-info-tip__bubble absolute z-[1100] w-64 max-w-xs rounded-lg bg-slate-800 px-3 py-2 text-xs font-medium leading-snug text-white shadow-lg"
