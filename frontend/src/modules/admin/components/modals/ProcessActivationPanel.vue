    ...
    <template v-else>
      ...
      <div v-if="view !== 'activate'" class="mt-3">
        <div v-if="showMenu" class="flex flex-wrap gap-2" role="group" aria-label="Resumen de activacion">
          <AdminButton variant="neutralOutline" :class="{ active: view === 'definition' }" @click="$emit('update:view', 'definition')">Configuracion</AdminButton>
          <AdminButton variant="neutralOutline" :class="{ active: view === 'rules' }" @click="$emit('update:view', 'rules')">Alcance</AdminButton>
          <AdminButton variant="neutralOutline" :class="{ active: view === 'triggers' }" @click="$emit('update:view', 'triggers')">Periodos</AdminButton>
          <AdminButton variant="neutralOutline" :class="{ active: view === 'artifacts' }" @click="$emit('update:view', 'artifacts')">Paquetes</AdminButton>
        </div>
