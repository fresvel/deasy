    ...
    <div v-show="activeTab === 'campos'" class="mt-4">
      ...
      <div v-else class="mt-3 flex flex-col gap-2">
        <div v-for="(field, index) in schemaFields" :key="index" class="deasy-card grid grid-cols-12 items-end gap-2 px-3 py-2.5">
          ...
          <div class="col-span-3">
            <label :for="fieldId(`field-title-${index}`)" class="deasy-form-label">Etiqueta</label>
          ...
          <div class="col-span-2">
            <label :for="fieldId(`field-component-${index}`)" class="deasy-form-label">Componente</label>
          ...
          <div v-show="expandedFillStep === index" class="border-t border-line px-3 py-2.5">
            ...
            <div v-if="stepWhoMode(step) === 'scope'" class="mt-2 grid grid-cols-12 gap-2">
              <div class="col-span-4">
                <label :for="fieldId(`fill-unit-scope-type-${index}`)" class="deasy-form-label">Ubicación</label>
              ...
              <template v-if="fillStepNeedsUnit(step)">
                <div class="col-span-4">
                  <label :for="fieldId(`fill-filter-unit-type-id-${index}`)" class="deasy-form-label">Tipo (filtro)</label>
                ...
                <div class="col-span-4">
                  <label :for="fieldId(`fill-unit-id-${index}`)" class="deasy-form-label">Unidad</label>
              ...
              <div v-else-if="fillStepNeedsUnitType(step)" class="col-span-4">
                <label :for="fieldId(`fill-unit-type-id-${index}`)" class="deasy-form-label">Tipo de unidad</label>
              ...
              <div class="col-span-4">
                <label :for="fieldId(`fill-cargo-id-${index}`)" class="deasy-form-label">Cargo</label>
            ...
            <div v-else-if="stepWhoMode(step) === 'person'" class="mt-2 grid grid-cols-12 gap-2">
              <div class="col-span-6">
                <label :for="fieldId(`fill-person-id-${index}`)" class="deasy-form-label">Persona</label>
          ...
          <div class="mt-3 border-t border-line pt-2">
            ...
            <div v-for="(signer, si) in stepSigners(step)" :key="`sig-${index}-${si}`" class="deasy-card mt-2 px-2.5 py-2">
              ...
              <div v-if="stepWhoMode(signer) === 'scope'" class="mt-2 grid grid-cols-12 gap-2">
                <div class="col-span-4">
                  <label :for="fieldId(`signer-unit-scope-type-${index}-${si}`)" class="deasy-form-label">Ubicación</label>
                ...
                <template v-if="fillStepNeedsUnit(signer)">
                  <div class="col-span-4">
                    <label :for="fieldId(`signer-filter-unit-type-id-${index}-${si}`)" class="deasy-form-label">Tipo (filtro)</label>
                  ...
                  <div class="col-span-4">
                    <label :for="fieldId(`signer-unit-id-${index}-${si}`)" class="deasy-form-label">Unidad</label>
                ...
                <div v-else-if="fillStepNeedsUnitType(signer)" class="col-span-4">
                  <label :for="fieldId(`signer-unit-type-id-${index}-${si}`)" class="deasy-form-label">Tipo de unidad</label>
                ...
                <div class="col-span-4">
                  <label :for="fieldId(`signer-cargo-id-${index}-${si}`)" class="deasy-form-label">Cargo</label>
              ...
              <div v-else-if="stepWhoMode(signer) === 'person'" class="mt-2 grid grid-cols-12 gap-2">
                <div class="col-span-6">
                  <label :for="fieldId(`signer-person-id-${index}-${si}`)" class="deasy-form-label">Persona</label>
