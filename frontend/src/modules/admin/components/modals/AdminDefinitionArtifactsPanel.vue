<template>
  <div>
    ...
    <div v-if="context && !canManage" class="rounded-2xl border border-sky-200 bg-sky-50 px-4 py-3 text-sm text-sky-800">
      Esta configuracion no esta en draft. Solo puedes gestionar artifacts cuando la configuracion este en draft.
    </div>
    ...
    <div class="person-assignment-form">
      <div class="grid gap-3 md:grid-cols-12">
        ...
        <AdminFieldGroup label="Modo de instancia" group-class="md:col-span-6">
          <AdminSelectField :model-value="form.instance_mode" :disabled="!canManage" @update:model-value="updateField('instance_mode', $event)">
            ...
            <option value="owner_many_documents">owner_many_documents</option>
          </AdminSelectField>
        </AdminFieldGroup>
