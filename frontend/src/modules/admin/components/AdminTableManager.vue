...
import { useAdminFkManager } from "@/modules/admin/composables/useAdminFkManager";
import { useAdminFkCrud } from "@/modules/admin/composables/useAdminFkCrud";
import { useAdminFkSearch } from "@/modules/admin/composables/useAdminFkSearch";
import { useAdminEditorFlow } from "@/modules/admin/composables/useAdminEditorFlow";
import { useAdminDraftArtifactFlow } from "@/modules/admin/composables/useAdminDraftArtifactFlow";
import { useAdminFeedbackToast } from "@/modules/admin/composables/useAdminFeedbackToast";
import { useAdminFkLabels } from "@/modules/admin/composables/useAdminFkLabels";
import { useAdminFormState } from "@/modules/admin/composables/useAdminFormState";
import { useAdminModalRegistry } from "@/modules/admin/composables/useAdminModalRegistry";
import { useAdminModalStack } from "@/modules/admin/composables/useAdminModalStack";
import { useAdminOptionLoaders } from "@/modules/admin/composables/useAdminOptionLoaders";
import { useAdminPresentationAdapters } from "@/modules/admin/composables/useAdminPresentationAdapters";
import { useAdminShellHelpers } from "@/modules/admin/composables/useAdminShellHelpers";
import { useAdminShellSearchActions } from "@/modules/admin/composables/useAdminShellSearchActions";
import { useAdminSyncActions } from "@/modules/admin/composables/useAdminSyncActions";
import { useAdminTableReset } from "@/modules/admin/composables/useAdminTableReset";
import { usePersonAssignmentsManager } from "@/modules/admin/composables/usePersonAssignmentsManager";
import { useAdminRecordViewer } from "@/modules/admin/composables/useAdminRecordViewer";
import { useAdminSearchFilters } from "@/modules/admin/composables/useAdminSearchFilters";
import { useAdminTableDataSource } from "@/modules/admin/composables/useAdminTableDataSource";
import { useProcessDefinitionActivationFlow } from "@/modules/admin/composables/useProcessDefinitionActivationFlow";
import { useProcessDefinitionManager } from "@/modules/admin/composables/useProcessDefinitionManager";
import { useAdminSubmitFlow } from "@/modules/admin/composables/useAdminSubmitFlow";
...
import AdminFeedbackToast from "@/modules/admin/components/AdminFeedbackToast.vue";
import AdminDefinitionArtifactsModal from "@/modules/admin/components/AdminDefinitionArtifactsModal.vue";
import AdminDefinitionCreatedPromptModal from "@/modules/admin/components/AdminDefinitionCreatedPromptModal.vue";
import AdminDefinitionRulesModal from "@/modules/admin/components/AdminDefinitionRulesModal.vue";
import AdminDefinitionTriggersModal from "@/modules/admin/components/AdminDefinitionTriggersModal.vue";
import AdminDeleteConfirmModal from "@/modules/admin/components/AdminDeleteConfirmModal.vue";
import AdminDraftArtifactModal from "@/modules/admin/components/AdminDraftArtifactModal.vue";
import AdminEditorModal from "@/modules/admin/components/AdminEditorModal.vue";
import AdminFkViewerModal from "@/modules/admin/components/AdminFkViewerModal.vue";
import AdminMainTableSection from "@/modules/admin/components/AdminMainTableSection.vue";
import AdminFieldGroup from "@/modules/admin/components/AdminFieldGroup.vue";
import AdminFkBrowserModal from "@/modules/admin/components/AdminFkBrowserModal.vue";
import AdminFkCreateModal from "@/modules/admin/components/AdminFkCreateModal.vue";
import AdminFkFilterModal from "@/modules/admin/components/AdminFkFilterModal.vue";
...
import AdminPersonAssignmentsModal from "@/modules/admin/components/AdminPersonAssignmentsModal.vue";
import AdminProcessDefinitionActivationModal from "@/modules/admin/components/AdminProcessDefinitionActivationModal.vue";
import AdminProcessDefinitionVersioningModal from "@/modules/admin/components/AdminProcessDefinitionVersioningModal.vue";
import AdminRecordViewerModal from "@/modules/admin/components/AdminRecordViewerModal.vue";
