        ...
        <div class="bg-brand-surface-muted/60 px-4 py-5 sm:px-6 lg:px-8">
          <form @submit.prevent="createnewUser" class="mx-auto max-w-4xl">
            ...
            <section class="deasy-form-section">
              ...
              <div class="mt-5 rounded-xl border border-brand-border bg-slate-50/70 p-4">
                ...
                <div v-show="showMap" class="mt-4">
                  <div ref="mapElement" class="z-10 h-75 w-full rounded-xl border border-brand-border shadow-inner"></div>
                </div>
              </div>
            </section>
              ...
              <div class="deasy-form-grid">
                <div>
                  ...
                  <div v-if="newuser.password" class="mt-2">
                    <div class="mb-1 flex h-1.5 w-full overflow-hidden rounded-full bg-brand-surface-muted">
                      <div
            ...
            <div class="sticky bottom-0 mt-6 flex flex-col gap-3 border-t border-brand-border bg-brand-surface-muted/95 py-4 backdrop-blur sm:flex-row">
