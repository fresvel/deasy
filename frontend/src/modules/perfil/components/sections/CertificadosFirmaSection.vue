<template>
  <div class="w-full">
    <section class="bg-brand-white rounded-2xl shadow-sm border border-brand-border p-6">
      <div class="mb-6">
        <h2 class="text-2xl font-bold text-slate-800 m-0">Certificados de firma</h2>
