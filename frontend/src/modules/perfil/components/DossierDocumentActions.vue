<template>
  ...
  <div class="inline-flex items-center gap-2">
    ...
    <AdminButton v-if="hasDocument" variant="infoSoft" size="sm" icon-only
    ...
    <AdminButton v-if="hasDocument" variant="primarySoft" size="sm" icon-only
    ...
    <AdminButton variant="primarySoft" size="sm" icon-only 
    ...
    <AdminButton v-if="hasDocument" variant="warningSoft" size="sm" icon-only
    ...
    <AdminButton variant="dangerSoft" size="sm" icon-only 
