    ...
    >
      <template #header>
        <div id="home-signature-sign-modal" class="flex min-w-0 flex-1 items-center gap-4">
          ...
          <div class="min-w-0">
            <div class="deasy-overline">Firmador singular</div>
    ...
    >
      <template #header>
        <div id="home-signature-request-modal" class="flex min-w-0 flex-1 items-center gap-4">
          ...
          <div class="min-w-0">
            <div class="deasy-overline">Solicitud singular</div>
      ...
      <template #header>
        <div id="home-signature-general-multisigner-modal" class="flex min-w-0 flex-1 items-center gap-4">
          <div class="flex min-w-0 max-w-[22rem] items-center gap-3">
            ...
            <div class="min-w-0">
              <div class="deasy-overline">Previsualizando PDF</div>
      ...
      <div class="flex flex-col gap-5 p-6">
        <div class="deasy-filter-shell">
          ...
          <div class="deasy-filter-actions">
            <AppButton variant="neutral-outline" icon-only @click="resetTableFilters" title="Limpiar filtros" aria-label="Limpiar filtros"><font-awesome-icon icon="times" /></AppButton>
            <AppButton variant="primary-outline" :disabled="pendingPreparation" @click="openSelectedInMultiSigner">
