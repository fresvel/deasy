<template>
  <section class="flex flex-col gap-5">
    ...
    <div class="overflow-hidden rounded-[1.75rem] border border-indigo-100 bg-linear-to-br from-indigo-50/70 via-white to-sky-50/50 shadow-sm">
      <div class="flex flex-col gap-4 px-5 py-5 md:flex-row md:items-center md:justify-between md:px-6">
        ...
        <div class="flex shrink-0 items-center gap-2">
          <button
            type="button"
            class="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-brand-border bg-white text-slate-500 transition hover:border-sky-200 hover:bg-sky-50 hover:text-sky-700"
            title="Actualizar"
    ...
    <div class="flex items-center gap-1.5 rounded-2xl border border-brand-border/80 bg-white p-1.5 shadow-sm">
      ...
      >
        ...
        <span
          ...
          :class="activeTab === tab.key ? 'bg-white/25 text-white' : 'bg-brand-surface-muted text-slate-500'"
    ...
    >
      <span class="inline-flex h-14 w-14 items-center justify-center rounded-2xl border border-brand-border bg-white text-slate-300">
