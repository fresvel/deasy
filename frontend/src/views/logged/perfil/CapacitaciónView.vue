              ...
              <td class="text-end">
                <div class="dropdown d-inline-block">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                      <button class="dropdown-item hope-dropdown-edit" type="button" @click="editarCapacitacion(capacitacion)">
                        <svg
                          width="18"
                          height="18"
                          viewBox="0 0 24 24"
                    ...
                    <li>
                      <button class="dropdown-item hope-dropdown-delete" type="button" @click="openDelete(capacitacion)">
                        <svg
                          width="18"
                          height="18"
                          viewBox="0 0 24 24"
