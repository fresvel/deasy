  ...
  >
    ...
    <div class="person-assignment-form">
      <div class="row g-3">
        <AdminFieldGroup label="Alcance" label-class="text-dark" group-class="col-12 col-md-3">
          <AdminSelectField :model-value="form.unit_scope_type" :disabled="!canManage" @update:model-value="updateField('unit_scope_type', $event)" @change="$emit('scope-change')">
        ...
        <div class="col-12 col-md-3">
          ...
          <AdminLookupField
            ...
            @search="$emit('search-field', 'unit_id')"
          />
        </div>
        <div class="col-12 col-md-3">
          ...
          <AdminLookupField
            ...
            @search="$emit('search-field', 'unit_type_id')"
          />
        </div>
        <div class="col-12 col-md-3">
          ...
          <AdminLookupField
            ...
            @search="$emit('search-field', 'cargo_id')"
          />
        </div>
        <div class="col-12 col-md-4">
          ...
          <AdminLookupField
            ...
            @search="$emit('search-field', 'position_id')"
          />
        </div>
    ...
    >
      <template #cell="{ row, field }">
        ...
        <template v-else>
          {{ formatDefinitionRuleCell(row, field.name) }}
        </template>
      </template>
...
const props = defineProps({
  ...
  formatDefinitionRuleCell: { type: Function, required: true }
});
