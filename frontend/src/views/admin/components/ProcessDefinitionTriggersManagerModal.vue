    ...
    <div class="person-assignment-form">
      <div class="row g-3">
        <AdminFieldGroup label="Modo de disparo" label-class="text-dark" group-class="col-12 col-md-4">
          <AdminSelectField :model-value="form.trigger_mode" :disabled="!canManage" @update:model-value="updateField('trigger_mode', $event)" @change="$emit('mode-change')">
