...
\def\firmaElaboradoToken{!-1234567891-!}
\def\firmaRevisadoToken{!-0000000000-!}
\def\firmaAprobadoToken{!-0000000000-!}
\def\nombreElaborado{Mgt. Docente Demo Principal}
\def\nombreRevisado{Mgt. Revisor Demo Principal}
\def\nombreAprobado{Mgt. Aprobador Demo Principal}
...
\def\carrera{Ingeniería en Tecnologías de la Información}
\def\coordinador{Docente Demo Principal}

% Layouts
\def\layoutDefaultName{portrait}

\def\layoutOptionsportrait{a4paper,portrait, total={160mm,247mm}, left=25mm, right=25mm, top=0mm, bottom=0mm}

\def\layoutOptionslandscape{a4paper,landscape, total={289mm,170mm}, left=4mm, right=4mm, top=0mm, bottom=0mm}
