...
% Asegura que los valores ingresados en campos de formulario se vean en lectores
% que no generan automáticamente las apariencias (ej. visor de Chrome).
\pdfcatalog{/AcroForm << /NeedAppearances true >> }
