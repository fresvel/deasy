...
1. [x] Confirmar el caso de uso prioritario del MVP: thread de proceso abierto desde el home antes que chat global, grupos o bandeja universal.
...
9. [x] Exponer la API mínima `/chat` y `/notifications`, incluyendo endpoints de conveniencia por `process_id` para el panel del home.
10. [x] Implementar el launcher flotante del chat en la esquina inferior derecha y definir el patrón overlay del panel sin comprimir el contenido principal del home.
...
12. [x] Integrar el panel de usuario o home para que el botón `Chat del proceso` abra el flujo real dentro de ese overlay y deje de mostrar el placeholder actual.
...
16. [x] Ajustar el contrato de API y eventos para que sea reutilizable por una futura app móvil, sin acoplarlo a payloads o estructuras del home web.
