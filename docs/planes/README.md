...
|---|---|---|
| **[`plan-maestro-2026-08.md`](./plan-maestro-2026-08.md)** | **Los frentes pendientes**, ordenados por retorno sobre esfuerzo, cada uno con su criterio de cierre. El **frente 0 está CERRADO** (9 de 9, 2026-08-13): el modelo de dominio ya no se contradice. Lo que queda son los frentes 1-11. Incluye además **por qué la pregunta arquitectónica está cerrada** (se evaluaron 15 arquitecturas el 2026-08-09 y ninguna baja la complejidad) | **SÍ. Es la puerta de entrada.** |
| **[`defectos-conocidos/`](./defectos-conocidos/)** | **El frente 1 desarrollado**: los **5 defectos que quedan** (de 14), cada uno con diagnóstico remedido y criterio de cierre, más un **control de ejecución de 15 tareas** que se actualiza en el mismo commit que las cierra. Su `bitacora.md` guarda los **9 cerrados** con *por qué no se hizo de la otra forma* — cuatro sitios donde la corrección obvia es la equivocada | **SÍ**, vía frente 1 |
...
| [`referencia/metodo.md`](./referencia/metodo.md) | Las **17 reglas** de trabajo, los comandos, y **lo que NO hay que tocar**. Las cuatro últimas son de agosto y valen por sí solas: el **experimento desechable**, y las tres que explican por qué **verde no significa seguro, ni retirable, ni protegido** | Léelo **antes** de tocar código |
