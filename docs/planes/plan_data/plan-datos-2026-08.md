...
| `TD7-c5` | D7 | `dossiers.cedula` guarda lo mismo que `persons.cedula` | ⬜ | El mismo hecho dos veces, como el par polimórfico que murió en `TD7-c4`. Ahora que la FK existe, la cédula se obtiene de `persons` | — |
