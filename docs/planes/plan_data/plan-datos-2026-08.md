...
| `TD7-k` | D7 | **P5** · Eliminar un puesto deja de borrar su historia; desactivarlo emite `position_deactivated` | 🟡 | Lo de **desactivar** está hecho en `TD7-z3`. Queda **eliminar**: hoy la base lo rechaza con un error seco de FK, sin explicación. Y desactivar **NO cierra la ocupación** — la persona sigue figurando como titular vigente de un puesto que ya no existe | 2026-08-23 |
