...
por cada tabla?»*. La respuesta es **no** —está razonada con cifras en el §1 del plan—, pero para
...
|---|---|---|
| **[`plan-datos-2026-08.md`](./plan-datos-2026-08.md)** | Las **7 fases**, ordenadas por retorno sobre esfuerzo, cada una con su criterio de cierre, y el **§0 · Control de ejecución** al principio. Incluye **por qué se descarta una clase por tabla** y la lista de lo que el plan **no** va a hacer | **SÍ** |
...
## Las siete fases, en una línea cada una

**El estado vive en el `§0 · Control de ejecución` del plan**, no aquí; esto es el índice.

| | Fase | Estado |
|---|---|---|
| **D7** | **Auditoría funcional del modelo** — las decisiones que el frente 0 dejó abiertas. **Va la primera**: el número es orden de descubrimiento | ⬜ |
...
Cuando las siete fases estén cerradas, esta carpeta **se archiva** en
