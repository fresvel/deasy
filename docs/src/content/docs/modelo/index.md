...
| Columnas de esas 38 | **368** |
| Claves foráneas entre esas 38 | **97** |
| Tablas del esquema entero (con chat, empleo y dossier) | **74** |
| Claves foráneas del esquema entero | **158** |
| Restricciones `CHECK` del esquema entero | **35** |
