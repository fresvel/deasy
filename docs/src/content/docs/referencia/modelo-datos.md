...
description: Las 71 tablas de PostgreSQL, en ocho diagramas por dominio, generados desde el esquema.
sidebar:
  order: 1
---
...
Son **71 tablas y 150 relaciones**. Repartidas en ocho dominios porque un diagrama de 71 tablas
